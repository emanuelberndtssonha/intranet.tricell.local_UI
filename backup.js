function backupVirus(result) {
    return new Promise((resolve, reject) => {
        ...
        str_virusID = result.ID;
        str_objectNumber = result.objectNumber;
        str_objectName = result.objectName;
        str_objectCreator = result.objectCreator;
        str_objectCreateDate = result.objectCreateDate;
        str_objectCreateTime = result.objectCreateTime;
        str_objectText = result.objectText;
        str_objectStatus = result.objectStatus;
        var str_presentationVideoLink = "";
        var str_securityVideoLink = "";
        if (result.presentationVideoLink) {
            str_presentationVideoLink = result.presentationVideoLink;
        }
        if (result.securityVideoLink) {
            str_securityVideoLink = result.securityVideoLink;
        }
